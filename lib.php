...
function theme_adaptable_process_css($css, $theme) {
    ...
    $defaults = array(
        ...
        '[[setting:mobile]]' => '22',
        '[[setting:hideslidermobile]]' => 'd-none d-lg-block',
        ...
        '[[setting:coursetitlepaddingtop]]' => '0px',
        '[[setting:hidepagefootermobile]]' => 'd-none d-lg-block',
        '[[setting:hidealertsmobile]]' => 'd-none d-lg-block',
        '[[setting:hidesocialmobile]]' => 'd-none d-lg-block',
        '[[setting:hidefootersocial]]' => 1,
        '[[setting:hidecoursetitlemobile]]' => 'd-none d-lg-block',
        '[[setting:hidelogomobile]]' => 'd-none d-lg-block',
        '[[setting:hideheadermobile]]' => 'd-none d-lg-block',
